...
$query = $mysqli->prepare("select id, nome, login, senha, tipo, deleted_at from usuarios where id = $id and deleted_at = 1");
...
<div class="container bg-white">
    ...
    <?php if($msg):?>
    <div class="my-5 success">Tem certeza que deseja habilitar esse registro?</div>
    <form action="habilitar-action.php" method="post" class="my-5">
        ...
        <input type="submit" value="Habilitar" class="my-5">
    </form>
    <?php else:?>
